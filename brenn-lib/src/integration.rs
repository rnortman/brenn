    ...
    let mut tools = vec![
        ...
        VirtualToolDef {
            ...
            description: concat!(
                ...
                "Subscribing with `push_depth=N` to a channel that already holds retained ",
                "messages delivers up to the newest N of them as undelivered, once, at ",
                "subscribe: they are unseen by you, and the bus makes no recency promise. If ",
                "staleness matters, judge by the timestamp in the message.\n",
        ...
        VirtualToolDef {
            ...
            description: concat!(
                ...
                "Covers scheduled messages on `brenn:` channels only: a scheduled message sent ",
                "to an `ephemeral:` channel is not listed here. ",
        ...
        VirtualToolDef {
            ...
            description: [
                ...
                "Reaches scheduled messages on `brenn:` channels only. A message scheduled to ",
                "an `ephemeral:` channel cannot be cancelled: it answers \"",
                UNKNOWN_MESSAGE_ERR,
                " <uuid>\" even while still parked.\n\n",
        ...
        VirtualToolDef {
            ...
            description: [
                ...
                "Reaches scheduled messages on `brenn:` channels only, the same scope ",
                "BrennMessageCancel has: a message scheduled to an `ephemeral:` channel answers ",
                "\"",
                UNKNOWN_MESSAGE_ERR,
                " <uuid>\" even while still parked.\n\n",
    ...
    if enabled {
        tools.push(VirtualToolDef {
            ...
            description: concat!(
                ...
                "All three work on `brenn:` and `ephemeral:` targets alike; `reply_to` must name ",
                "a `brenn:` channel whatever the target is. One caveat: a `deliver_after` ",
                "message sent to an `ephemeral:` target cannot be cancelled or edited afterwards ",
                "— BrennMessageCancel and BrennMessageEdit reach `brenn:` targets only.\n\n",
