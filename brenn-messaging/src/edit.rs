...
//! `ParticipantId::for_app` identity).
...
impl Messenger {
    ...
    pub async fn edit(
        ...
        // 9. Kick the dispatcher for touched scheduling fields.
    ...
    ///
    /// An unresolvable or malformed channel address returns
    ...
    pub async fn list_pending(
        ...
        let channel_uuid_filter = if let Some(addr) = channel {
            match self.directory.resolve(addr) {
                ...
                None => return vec![], // unknown or malformed address → empty
            }
        } else {
            None
        };
...
mod tests {
    use super::*;
    use crate::config::{MessagingGlobalConfig, ResolvedMessagingConfig, ResolvedSubscription};
    ...
    struct CountingRouter {
        ...
        deliveries: tokio::sync::Mutex<Vec<crate::ParticipantId>>,
    ...
    impl WakeRouter for CountingRouter {
        ...
        async fn deliver_ingress(
            &self,
            _key: &crate::SubscriberEntryKind,
            subscriber: &crate::ParticipantId,
    ...
    async fn build_messenger(
        ...
        let entry = ChannelEntry {
            ...
            description: None,
            resolved_channel: crate::config::ResolvedChannel {
                send_rate: Default::default(),
                push_depth: crate::config::Depth::Unbounded,
                retain_depth: crate::config::Depth::Unbounded,
                standing_retain_depth: crate::config::Depth::Unbounded,
                noise: crate::config::NoiseLevel::Silent,
                sink: crate::config::Sink::Drop,
                wake_min: WakeMin::Normal,
            },
            subscribers: vec![crate::SubscriberEntry {
                kind: crate::SubscriberEntryKind::App("pa-alice".to_string()),
                push_depth: crate::config::Depth::Unbounded,
                retain_depth: crate::config::Depth::Unbounded,
                noise: crate::config::NoiseLevel::Silent,
    ...
    fn make_app_config(
        ...
        crate::test_support::test_app_config(slug, messaging, allowed_users)
    }
    ...
    async fn publish_one(
        ...
        match m
            ...
            .await
        {
            crate::PublishResult::Ok { message_id, .. } => message_id,
    ...
    fn history_query() -> crate::MessageQuery {
        crate::MessageQuery {
    ...
    async fn build_narrow_messenger() -> (Arc<Messenger>, Uuid) {
        ...
        let mk_entry = |name: &str, with_subscriber: bool| {
            ...
            crate::testutils::test_channel_entry(name, subscribers)
        };
    ...
    /// Authz coherence: `resolve_sender` must return the exact
