...
mod tests {
    ...
    use crate::db::{upsert_channels, utc_to_ns};
    use crate::{
    ...
    impl super::super::WakeRouter for FakeRouter {
        async fn deliver(
            ...
            _envelope: &Arc<crate::MessageEnvelope>,
            _retained_seq: i64,
        ) -> Result<bool, String> {
        ...
        async fn deliver_ingress(
            &self,
            _key: &crate::SubscriberEntryKind,
            _subscriber: &crate::ParticipantId,
    ...
    fn make_directory_and_channel(conn: &rusqlite::Connection) -> (MessagingDirectory, Uuid) {
        ...
        let entry = ChannelEntry {
            ...
            subscribers: vec![crate::SubscriberEntry {
                kind: crate::SubscriberEntryKind::App("target".to_string()),
                push_depth: crate::config::Depth::Unbounded,
                retain_depth: crate::config::Depth::Unbounded,
                noise: crate::config::NoiseLevel::Silent,
    ...
    fn insert_ingress_row(conn: &rusqlite::Connection, publish_ts_ns: i64) -> i64 {
        let (_, push_id) = crate::db::insert_ingress_message(
            conn,
