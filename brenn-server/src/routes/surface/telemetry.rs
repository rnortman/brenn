...
pub(super) async fn publish_terminal_disconnected_stamp(
...
mod tests {
    ...
    async fn stamp_messenger(
        ...
        let entries = vec![
            ...
            brenn_channel_entry(
                &super::super::description::surface_status_bare(&params.prefix, "deskbar"),
                status_uuid,
            ),
        ];
        crate::test_support::surface::derive_wire_subscriptions(&mut surfaces[0]);
        crate::test_support::surface::bind_wire_subscription_uuids(&mut surfaces[0], &entries);
    ...
    async fn rows_on(db: &db::Db, channel_uuid: uuid::Uuid) -> i64 {
