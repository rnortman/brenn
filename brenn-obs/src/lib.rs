//! Observability: the tracing layer stack, the diagnostic and security
//! transcripts, and the alert dispatcher that pages a human.
//!
//! `README.md` beside this file is the subsystem's own documentation.
