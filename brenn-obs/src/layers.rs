use crate::alerting::{AlertDispatcher, MailAlerter, NtfyAlerter, PanicMailConfig, RateLimiter};
...
mod tests {
    ...
    fn peer_security_log_line_matches_the_deployed_failregex() {
        ...
        tracing::subscriber::with_default(subscriber, || {
            crate::security::log_security_event(
                crate::security::SecurityEventType::AttachProtocolViolation,
    ...
    fn app_security_log_line_does_not_match_the_deployed_failregex() {
        ...
        let subscriber = tracing_subscriber::registry().with(security_log_layer(buf.clone()));
        tracing::subscriber::with_default(subscriber, || {
            crate::security::log_app_security_event(
                crate::security::SecurityEventType::EphemeralPublishDenied,
                "app-a",
                7,
