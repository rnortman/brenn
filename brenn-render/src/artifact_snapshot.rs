...
use brenn_ws_types::{SnapshotMetadata, WsServerMessage};
...
pub fn get_artifact_index(
    conn: &Connection,
    conversation_id: i64,
) -> Vec<brenn_ws_types::ArtifactFileInfo> {
    use brenn_ws_types::{ArtifactFileInfo, ArtifactVersionInfo};
...
pub fn version_counts_from_index(
    index: &[brenn_ws_types::ArtifactFileInfo],
