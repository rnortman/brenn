...
use brenn_db::conversation::{self, ConversationStatus, MessageDirection};
...
mod tests {
    ...
    use brenn_db::conversation::MessageDirection;
    ...
    fn replay_row_with_rendered_html_emits_system_broadcast() {
        ...
        match &history[0] {
            WsServerMessage::SystemMessageBroadcast {
                ...
                assert_eq!(
                    *category,
                    brenn_ws_types::SystemMessageCategory::CompactionReminder,
                );
    ...
    fn replay_system_row_attributed_to_human_emits_system_broadcast() {
        ...
        match &history[0] {
            WsServerMessage::SystemMessageBroadcast { category, .. } => {
                ...
                assert_eq!(
                    *category,
                    brenn_ws_types::SystemMessageCategory::CompactionUserRequest,
                );
            }
            other => panic!("expected SystemMessageBroadcast, got {other:?}"),
        }
    ...
    fn replay_ui_error_row_round_trips_category() {
        ...
        match &history[0] {
            WsServerMessage::SystemMessageBroadcast {
                ...
                assert_eq!(
                    *category,
                    brenn_ws_types::SystemMessageCategory::UiError,
    ...
    fn simplified_page_emits_system_row_with_category() {
        ...
        assert_eq!(
            msg.category,
            Some(brenn_ws_types::SystemMessageCategory::CompactionReminder),
        );
    ...
    /// Integration test for the wake-spawn drain race.
    ///
    ...
    fn wake_spawn_drain_visible_via_history_on_attach() {
        ...
        let rendered =
            crate::system_message::render_event_drain(&[brenn_messaging::IngressEvent {
                id: 1,
    ...
    ///
    /// This behaviour is intentional: a tab reconnecting
