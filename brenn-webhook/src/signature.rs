//! Webhook signature verification: the `verify_request` free function and its
//! result types.
//!
//! It provides:
...
//!
//! The `SignatureScheme` enum it dispatches on lives in
//! `brenn_lib::webhook::scheme`.
...
use brenn_lib::util::{hmac_sha256_parts_verify, hmac_sha256_verify};
use brenn_lib::webhook::config::ResolvedWebhookEndpoint;
use brenn_lib::webhook::is_valid_key_id;
use brenn_lib::webhook::scheme::{HexFormat, SignatureScheme};
...
pub fn verify_request(
    ...
    match &endpoint.scheme {
        ...
        SignatureScheme::BearerToken {
            ...
            let ct_equal = brenn_lib::util::eq_secret(supplied, kr.effective_key);
...
mod tests {
    ...
    use brenn_lib::util::hmac_sha256;
    use brenn_lib::webhook::config::ResolvedWebhookEndpoint;
    use brenn_lib::webhook::scheme::SignatureAlgorithm;
    ...
    fn make_hmac_raw_body_endpoint(
        ...
        ResolvedWebhookEndpoint {
            ...
            owner: brenn_lib::webhook::config::WebhookOwner::App("pa-test".into()),
