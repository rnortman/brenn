...
use super::*;
use crate::SurfaceRuntime;
use crate::fixtures_config::{SurfaceFixture, description_params};
use crate::test_fixtures::TEST_MAX_BODY_BYTES;
...
fn a_missing_output_stays_a_broken_invariant_for_a_surface() {
    assert_eq!(
        ...
        brenn_messaging::MissingChannelPosture::Invariant
    );
}
